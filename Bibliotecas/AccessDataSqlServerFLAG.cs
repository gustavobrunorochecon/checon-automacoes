...
{
    public class AccessDataSqlServerFLAG
    {
        ...
        public AccessDataSqlServerFLAG(int revenda)
        {
        ...
        public SqlConnection createConnection()
        {
            ...
            try
            {
                if (revenda == 1)
                {
                    ...
                    connBuilder.InitialCatalog = "FLEXX00111000";
                ...
                {
                    connBuilder.DataSource = "sql06.flexxone.com.br";
                    connBuilder.InitialCatalog = "FLEXX00111002";
                    connBuilder.IntegratedSecurity = false;
